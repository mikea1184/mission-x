# <    This will be my first project. 
   ---><      I am a (begineers) begineer. haha.
      -----><       i will be learning .py hopefully and build something along the way, wish me luck!!!
      
      
 {{{{  Thank you,     I am goijng to just borrow some of your code, i took it all but will only need some. 
